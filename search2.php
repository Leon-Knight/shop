...
$sql='select cat_id from category where parent_id=17';
$b=$pdo->prepare($sql);
$b->execute(); 
//$rel是二维数组
//2个产品
	                  	...
	                  	<div class="theme-popover">														
							...
							<div class="search-content">
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
									<?php 
									foreach($rel as $cat_id){
										$sql2='select * from product where cat_id=?';
										$p=$pdo->prepare($sql2);
										$p->execute(array($cat_id['cat_id']));
										$rel2=$p->fetchAll(PDO::FETCH_ASSOC);
										foreach($rel2 as $product){
									?>								
									<li>
