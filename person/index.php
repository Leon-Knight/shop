					...
					<div class="am-container header">
						<ul class="message-l">
							<div class="topMessage">
								<div class="menu-hd">
									<a href="#" target="_top" class="h">亲<?php echo $re[0]['username']?>您好欢迎你的到来</a>
									<a href="../register2.html" target="_top">免费注册</a>
								</div>
							</div>
						</ul>
						<ul class="message-r">
								...
								<div class="m-userinfo">
									...
									<div class="m-baseinfo">
										<a class="m-pic" href="information.html">
											<img src="../images/<?php echo $re[0]['headpicture']?>">
										</a>
										<div class="m-info">
											<em class="s-name">
				...
				<div class="mt-logo">
					...
					<div class="am-container header">
						<ul class="message-l">
							<div class="topMessage">
								<div class="menu-hd">
									<a href="../login1.html" target="_top" class="h">亲，请登录</a>
									<a href="../register2.html" target="_top">免费注册</a>
								</div>
							</div>
						</ul>
